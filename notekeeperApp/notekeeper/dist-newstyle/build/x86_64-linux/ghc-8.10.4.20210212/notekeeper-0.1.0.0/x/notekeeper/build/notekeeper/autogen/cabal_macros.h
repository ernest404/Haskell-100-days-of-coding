...
/* package notekeeper-0.1.0.0 */
#ifndef VERSION_notekeeper
#define VERSION_notekeeper "0.1.0.0"
#endif /* VERSION_notekeeper */
#ifndef MIN_VERSION_notekeeper
#define MIN_VERSION_notekeeper(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_notekeeper */
...
#define CURRENT_COMPONENT_ID "notekeeper-0.1.0.0-inplace-notekeeper"
